        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-slate-500 dark:text-slate-400 mb-8 max-w-2xl mx-auto">
              I have 8 years&apos; experience in software industry in designing, developing, creating, and testing web applications using JavaScript, NodeJS, React/Redux, and GraphQL.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                Specializing in modern web architectures and scalable cloud solutions
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
              ...
              <div className="text-center p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                <div className="text-3xl md:text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">440M+</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Weekly Emails</div>
              </div>
              <div className="text-center p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                <div className="text-3xl md:text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">100%</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Cloud Migrated</div>
              </div>
              <div className="text-center p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                <div className="text-3xl md:text-4xl font-bold text-blue-600 dark:text-blue-400 mb-2">6+</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Major Companies</div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-start gap-4 p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">M.S. in CS, The Ohio State University</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">Software Engineer at eBay, Palo Alto Networks</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white mb-1">Expertise</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400">React, NodeJS, AWS & GCP Specialist</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <a
                href="mailto:weiliu614@hotmail.com"
            ...
            <div className="flex justify-center gap-4">
              ...
              <a
                href="https://github.com/WeiLiuSDE"
                target="_blank"
                rel="noopener noreferrer"
